import { Box, Button, CircularProgress, createTheme, Divider, Paper, responsiveFontSizes, ThemeProvider, Typography } from '@mui/material';
...
export function News() {
    ...
    if (NewData.length === 0) {
        ...
        <Paper elevation={0} sx={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <CircularProgress />
        </Paper>
